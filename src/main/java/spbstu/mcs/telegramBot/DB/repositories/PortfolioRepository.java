...
public interface PortfolioRepository extends MongoRepository<Portfolio, String> {
    ...
    /**
     * Находит все портфели с указанной фиатной валютой.
     *
     * @param fiatCurrency фиатная валюта для поиска
     * @return список найденных портфелей
     * @throws org.springframework.dao.DataAccessException при ошибках доступа к данным
     */
    List<Portfolio> findByFiatCurrency(Currency.Fiat fiatCurrency);
