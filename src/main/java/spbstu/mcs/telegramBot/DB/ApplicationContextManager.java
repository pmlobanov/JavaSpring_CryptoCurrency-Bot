...
public class ApplicationContextManager implements AutoCloseable {
    ...
    private void initializeContext() {
        if (context == null) {
            ...
            context.register(MongoConfig.class, AppConfigurations.class, SchedulingConfig.class);
            context.scan("spbstu.mcs.telegramBot.DB", 
                        "spbstu.mcs.telegramBot.service",
                        "spbstu.mcs.telegramBot.cryptoApi",
                        "spbstu.mcs.telegramBot.security",
                        "spbstu.mcs.telegramBot.DB.encryption");
            context.refresh();
        }
    }
    ...
    public AdminAuthMiddleware getAdminAuthMiddleware() {
        return context.getBean(AdminAuthMiddleware.class);
    }
}